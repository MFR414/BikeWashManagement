        ...
        <div class="col-md-12">
           <div class="panel panel-default">
               <div class="panel-heading">
                ...
                @endif
               <form class="form-horizontal" action="{{ route('owner.admin.store')}}" method="POST">
                @csrf
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2">Posisi :</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="posisi" placeholder="Masukkan Posisi (Posisi: owner,admin)">
                            </div>
                    </div>
