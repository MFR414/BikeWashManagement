        ...
        <div class="col-md-12">
           <div class="panel panel-default">
               <div class="panel-heading">
                   <h3>Form Edit Booking Antrian Motor</h3>
               </div>
                @if ($errors->any())
                ...
                <form class="form-horizontal" action="{{ route('bikebooking.update',['id'=> $bikequeueData['id']]) }}" method="POST">
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" >
                            <input type="date" class="form-control" name="booking_date" value="{{$bikequeueData['booking_date']}}" placeholder="Estimasi Waktu Selesai" id="txtDate">
                        </div>
                    </div>
