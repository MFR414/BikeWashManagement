    ...
    <div class="row">
        <div class="col-md-12">
           <div class="panel panel-default">
               ...
               <form class="form-horizontal" action="{{ route('carpetqueue.store')}}" method="POST">
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="date" class="form-control" name="estimation_time_date" placeholder="Estimasi Waktu Selesai" id="txtDate">
                        </div>
                    </div>
