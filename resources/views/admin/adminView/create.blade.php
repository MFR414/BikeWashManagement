           ...
           <div class="panel panel-default">
               ...
               <form class="form-horizontal" action="{{ route('admin.store')}}" method="POST">
                @csrf
                    ...
                    <div class="col-sm-10">
                        <input type="password" class="form-control" name="password" placeholder="Masukkan Password (huruf kecil)">
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2">Posisi :</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="address" placeholder="Masukkan Posisi (huruf kecil)">
                            </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="phone_number" placeholder="Masukkan Nomor Telefon (huruf kecil)">
                        </div>
                        </div>
